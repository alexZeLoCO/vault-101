...
| Eficiencia en el almacenamiento | - | $1 \over 2$ | $1 \over 2$ | ${n - 1} \over n$ |  |
| Prestaciones de lectura | $n \cdot p$ | $2 \cdot p$ | $n \cdot p$ | $(n-1) \cdot p$ |  |
| Prestaciones de escritura | $n \cdot p$ | p | ${n \over 2} \cdot p$ |  |  |
